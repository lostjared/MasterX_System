...
struct mxApp {
  ...
  void shutdown();
  bool full = false;
  void font_printText(TTF_Font *fnt, int x, int y, const std::string &text,
                      const SDL_Color col);
  void font_printText_Solid(TTF_Font *fnt, int x, int y,
                            const std::string &text, const SDL_Color col);
  void printText(int x, int y, const std::string &text, const SDL_Color col);
  void printText_Solid(int x, int y, const std::string &text,
                       const SDL_Color col);
...
extern SDL_Texture *loadTexture(mx::mxApp &app, const std::string &name, int &w,
